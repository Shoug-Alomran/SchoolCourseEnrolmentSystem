...
public class dataManager {
            ...
            try (BufferedReader reader = new BufferedReader(new FileReader(STUDENTS_FILE))) {
                ...
                while ((line = reader.readLine()) != null) {
                    ...
                    if (parts.length >= 7) {
                        ...
                        Student student = new Student(name, id, password, email, phoneNumber, address, creditLimit, enrolledCourses);
            ...
            try (BufferedReader reader = new BufferedReader(new FileReader(COURSES_FILE))) {
                ...
                while ((line = reader.readLine()) != null) {
                    ...
                    if (parts.length >= 8) {
                        ...
                        Course course = new Course(courseName, courseCode, schedule, description, status, instructor, capacity, new ArrayList<>(), creditHours);
        ...
        public void assignInstructorToCourse(String courseCode, String instructorId) {
            ...
            if (course.getInstructor() == null) {
                ...
                System.out.printf("Instructor %s is already assigned to %s.%n", instructor.getName(), course.getCourseName());
            } else {
        ...
        public void viewEnrollmentStatistics() {
            ...
            for (Course course : courses) {
                ...
                totalEnrolled += count;
                System.out.printf("Course: %s (%s) - Enrolled: %d%n", course.getCourseName(), course.getCourseCode(), count);
